...
urlpatterns = [
    ...
    path("<int:ticket_id>/ticket/", views.TicketDetailView.as_view(), name="ticket_detail_view"),
    path(
        "<int:ticket_id>/bookedticket/", views.BookingTicketView.as_view(), name="booking_ticket_view"
    ),
    path(
        "bookedlist/",
